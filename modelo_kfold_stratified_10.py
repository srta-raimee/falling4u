...
def run_kfold_training(kfold_base_dir, output_csv, k_folds=5, epochs=100, batch_size=8, model_name="yolo11n.pt", patience=20):
    CSV_RESULTS_FILE = output_csv
    CSV_FOLDS_LOG_FILE = 'resultados_detalhados_por_fold_stratified.csv'
    K_FOLDS = k_folds
    EPOCHS = epochs
...
if __name__ == '__main__':
    LISTA_DE_FOLDS = [10]
    OUTPUT_CSV_FILE = 'resultados_kfold_stratified.csv'
    NUM_EPOCHS = 100
    BATCH_SIZE = 8
    MODELO = "yolo11n.pt"
    PATIENCE = 20
